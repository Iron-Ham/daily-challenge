...
public class SearchEngineSnippetsTests {
	...
	public void testOne() {
		...
		assertEquals("test one must be \"c d a\"", answer, SearchEngineSnippets.answer(document, searchTerms));
	}
	...
	public void testTwo() {
		...
		assertEquals("test two must be \"friend once\"", answer, SearchEngineSnippets.answer(document, searchTerms));
	}
	...
	public void testThree() {
		...
		assertEquals("test three must be \"howdy google can program\"", answer, SearchEngineSnippets.answer(document, searchTerms));
	}
	...
	public void testFour() {
		...
		assertEquals("test four must be \"c d a\"", answer, SearchEngineSnippets.answer(document, searchTerms));
	}
