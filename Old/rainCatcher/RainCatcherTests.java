...
public class RainCatcherTests {
	...
	public void testOne() {
		...
		int output = 5;
		assertEquals("Test one should equal 5", output, RainCatcher.answer(heights));
	}
	...
	public void testTwo() {
		...
		int output = 0;
		assertEquals("Test two should equal 0", output, RainCatcher.answer(heights));
	}
...
//
	...
	public void testLocalMaxima() {
		...
		localMaxima.add(6);
		localMaxima.add(8);
		assertEquals("Local maxima are 0, 4 , 6, 8", localMaxima, RainCatcher.findLocalMaxima(heights));
	}
